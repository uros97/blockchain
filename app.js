...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, args, req.username, req.orgname,false);
	res.send(message);
});

// Upgrade chaincode on target peers
app.post('/channels/:channelName/chaincodesUpdate', async function(req, res) {
	...
	let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, args, req.username, req.orgname,true);
	res.send(message);
});
